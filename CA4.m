...
for i=1:M
    for j=1:M
        ...
        if ( d<city_0_r && y(i,j)==-1 && rand <0.7)
            y(i,j)=0;
        end
    end
end
...
for i=1:M
    for j=1:M
        if ( j-30<i && i-30<j && i>165 && i<240 && rand<0.8)
            y(i,j)=0;
        end
    end
end
...
for i=1:M
    for j=1:M
        if ( j-30<i && i-30<j && i>250 && i<320 && rand<0.6)
            y(i,j)=0;
        end
    end
end
...
for i=1:M
    for j=1:M
        if ( j-30<500-i && j+30>500-i && i>165 && i<240 && rand<0.4)
            y(i,j)=0;
        end
    end
end
...
for i=1:M
    for j=1:M
        if ( j-30<500-i && j+30>500-i && i>250 && i<320 && rand<0.2)
            y(i,j)=0;
        end
    end
end
...
for t=1:iter
    ...
    title(['时刻：',num2str(t)]);
    if (t==20)
        print(gcf, '-dpng','E:\DESKTOP\传染病模型\ca4\Image1.jpg');   
    end
    if (t==iter/2.5)
        print(gcf, '-dpng','E:\DESKTOP\传染病模型\ca4\Image2.jpg');    
    end
    if (t==iter-100)
        print(gcf, '-dpng','E:\DESKTOP\传染病模型\ca4\Image3.jpg');    
    end
    pause(0.01)                         % 暂停0.01s
...
print(gcf, '-dpng', 'E:\DESKTOP\传染病模型\ca4\Image4.jpg' ); 
grid on;
