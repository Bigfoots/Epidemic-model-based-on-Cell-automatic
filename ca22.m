...
for t=1:iter
    ...
    title(['时刻：',num2str(t)]);
    if (t==50)
        print(gcf, '-dpng','E:\DESKTOP\传染病模型\ca2.2\Image1.jpg');   
    end
    if (t==iter/2.5)
        print(gcf, '-dpng','E:\DESKTOP\传染病模型\ca2.2\Image2.jpg');    
    end
    if (t==1000)
        print(gcf, '-dpng','E:\DESKTOP\传染病模型\ca2.2\Image3.jpg');    
    end
    pause(0.01)                         % 暂停0.01s
...
print(gcf, '-dpng', 'E:\DESKTOP\传染病模型\ca2.2\Image4.jpg' ); 
